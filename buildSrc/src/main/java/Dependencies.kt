...
object Squareup {
    ...
    private const val versionOkhttp3 = "4.9.0"
    ...
    const val okhttp3 = "com.squareup.okhttp3:logging-interceptor:${versionOkhttp3}"
...
object MockK {
    private const val versionMockk = "1.12.0"

    const val core = "io.mockk:mockk:${versionMockk}"
    const val android = "io.mockk:mockk-android:${versionMockk}"
}
...
object SantaLu {
    ...
    const val maskedEditText = "com.github.santalu:maskara:${version}"
}
